import { app as c, BrowserWindow as h, ipcMain as a, dialog as w } from "electron";
...
const _ = i.dirname(v(import.meta.url));
...
async function E() {
  ...
  e = new h({
    ...
    async (n, r, l, p) => {
      try {
        ...
        const P = l.replace(/^data:image\/\w+;base64,/, ""), u = Buffer.from(P, "base64"), d = o.join(t, p);
        return f.writeFileSync(d, u), d;
      } catch {
  ...
  })), m ? e.loadURL(m) : (e.removeMenu(), e.loadFile(o.join(R, "index.html")));
}
